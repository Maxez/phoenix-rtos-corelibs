...
#define GRAPH_VGADEV    (1 << 1) /* Generic VGA graphics adapter */


/* Graphics adapters supported on IA32 platform */
#ifdef TARGET_IA32
#define GRAPH_CIRRUS    (1 << 2) /* Cirrus Logic graphics adapter */
// #define GRAPH_SAVAGE4   (1 << 3) /* S3 Savage4 graphics adapter */
// #define GRAPH_GEODELX   (1 << 4) /* AMD Geode LX graphics adapter */
// #define GRAPH_CT69000   (1 << 5) /* IBM CT69000 graphics adapter */
#endif
...
/* Commits framebuffer changes (flushes framebuffer onto the screen) */
